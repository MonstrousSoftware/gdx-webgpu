...
public class WebGPUWindowConfiguration {
	int windowX = -1;
	int windowY = -1;
	int windowWidth = 640;
	...
	WebGPUGraphics.WebGPUMonitor maximizedMonitor;
	...
	void setWindowConfiguration (WebGPUWindowConfiguration config) {
	...
	public void setMaximizedMonitor (Graphics.Monitor monitor) {
		this.maximizedMonitor = (WebGPUGraphics.WebGPUMonitor)monitor;
	}
	...
	/** Sets the {@link WebGPUWindowListener} which will be informed about iconficiation, focus loss and window close events. */
	public void setWindowListener (WebGPUWindowListener windowListener) {
