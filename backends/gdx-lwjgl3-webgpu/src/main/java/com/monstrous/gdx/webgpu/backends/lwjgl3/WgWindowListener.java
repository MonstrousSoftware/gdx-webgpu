 ...
 * set per window via {@link WgApplicationConfiguration} and {@link WgWindowConfiguration}. Close events can be canceled
 * by returning false.
 *
 * @author badlogic */
public interface WgWindowListener {

	/** Called after the GLFW window is created. Before this callback is received, it's unsafe to use any {@link WgWindow}
	 ...
	 * {@link WgApplication#WgApplication(ApplicationListener, WgApplicationConfiguration)}.
	 *
	 * @param window the window instance
	 *
	 * @see WgApplication#newWindow(ApplicationListener, WgWindowConfiguration) */
	void created (WgWindow window);
	 ...
	 * {@link WgGraphics#requestRendering()} is automatically called. */
