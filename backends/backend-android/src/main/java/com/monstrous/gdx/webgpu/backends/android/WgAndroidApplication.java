...
import com.badlogic.gdx.backends.android.DisabledAndroidAudio;
...
public class WgAndroidApplication extends Activity implements AndroidApplicationBase {
    ...
    public void initialize(ApplicationListener listener, AndroidApplicationConfiguration config) {
        initWebGPU(listener, config, false);
    }
    ...
    public View initializeForView(ApplicationListener listener, AndroidApplicationConfiguration config) {
        initWebGPU(listener, config, true);
        return graphics.getView();
    }

    private void initWebGPU(ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
    ...
    protected void onPause() {
        ...
        boolean isContinuousEnforced = WgAndroidGraphics.enforceContinuousRendering;

        // from here we don't want non continuous rendering
        WgAndroidGraphics.enforceContinuousRendering = true;
        ...
        WgAndroidGraphics.enforceContinuousRendering = isContinuousEnforced;
    ...
    protected void onResume() {
        ...
        ((WgAndroidGraphics)getGraphics()).getView().post(new Runnable() {
            @Override
            public void run() {
    ...
    public void exit() {
        handler.post(new Runnable() {
            @Override
            public void run() {
                WgAndroidApplication.this.finish();
            }
        });
    }
    ...
    protected WgAndroidGraphics createGraphics(AndroidApplicationConfiguration config) {
        return new WgAndroidGraphics(this, config,
