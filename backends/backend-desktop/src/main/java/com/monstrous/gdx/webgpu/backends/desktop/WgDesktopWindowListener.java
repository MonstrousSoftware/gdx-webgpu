...
/**
 * Receives notifications of various window events, such as iconification, focus loss and gain, and window close events.
 * Can be set per window via {@link WgDesktopApplicationConfiguration} and {@link WgDesktopWindowConfiguration}. Close
...
public interface WgDesktopWindowListener {
     ...
     * {@link WgDesktopWindow} member functions which, for their part, involve calling GLFW functions.
     *
     ...
     * state. When a window becomes iconified, its {@link ApplicationListener} will be paused, and when restored it will
     * be resumed.
     *
