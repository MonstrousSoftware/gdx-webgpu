...
public class WgDesktopWindow implements Disposable {
    ...
    WgDesktopWindow(ApplicationListener listener, Array<LifecycleListener> lifecycleListeners,
            WgDesktopApplicationConfiguration config, WgDesktopApplication application) {
    ...
    /**
     * Post a {@link Runnable} to this window's event queue. Use this if you access statics like {@link Gdx#graphics} in
     * your runnable instead of {@link Application#postRunnable(Runnable)}.
     */
    ...
    /**
     * Sets the position of the window in logical coordinates. All monitors span a virtual surface together. The
     * coordinates are relative to the first monitor in the virtual surface.
     **/
    ...
    /**
     * @return the window position in logical coordinates. All monitors span a virtual surface together. The coordinates
     *         are relative to the first monitor in the virtual surface.
     **/
    ...
    /**
     * Minimizes (iconifies) the window. Iconified windows do not call their {@link ApplicationListener} until the
     * window is restored.
     */
     ...
     * are ignored. Use -1 to indicate an unrestricted dimension.
     */
