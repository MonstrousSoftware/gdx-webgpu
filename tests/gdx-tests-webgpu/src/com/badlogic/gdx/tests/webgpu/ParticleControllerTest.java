...
public class ParticleControllerTest extends BaseG3dTest {
    ...
    public static void main (String[] argv) {
        new WebGPUApplication(new ParticleControllerTest());
    }
	...
	protected void onLoaded () {
		WebGPUTexture particleTexture = assets.get(DEFAULT_PARTICLE);
		billboardParticleBatch.setTexture(assets.get(DEFAULT_PARTICLE, WebGPUTexture.class));
