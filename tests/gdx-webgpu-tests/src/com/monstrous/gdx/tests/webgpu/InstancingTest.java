...
public class InstancingTest extends GdxTest {
    ...
    final static String[] fileNames = {"data/g3d/head.g3db", "data/g3d/gltf/ducky.glb", "data/g3d/monkey.g3db",
            "data/g3d/teapot.g3db", "data/g3d/ship.obj", "data/g3d/webgpu.obj"};
    ...
    public void render() {
        ...
        batch.begin();
        int y = 250;
        font.draw(batch, "Draw calls: " + modelBatch.drawCalls + " shader switches: " + modelBatch.shaderSwitches, 0,
                y -= 20);
