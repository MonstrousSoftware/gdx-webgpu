...
public class WebGPUTests {
    public static final List<Class<? extends GdxTest>> tests = new ArrayList<Class<? extends GdxTest>>(
            Arrays.<Class<? extends GdxTest>>asList(
                    ...
                    ModelBatchOutlineTest.class, WrapAndFilterTest.class, LoadObjTest.class, LoadG3DJTest.class,
                    LoadModelTest.class, LoadGLTFTest.class, LightingTest.class, InstancingTest.class,
                    ViewportTest.class, ScissorTest.class, ASimpleGame.class, ParticleEmitterTest.class,
                    ParticleEmittersTest.class, HeightMapTest.class, FullScreenTest.class, GPUTimerTest.class,
                    FrameBufferTest.class, PostProcessing.class, SuperKoalio.class, DistanceFontTest.class,
                    DepthClearTest.class, FogTest.class, ShadowTest.class, TextureAtlasTest.class,
                    TestTextureMipMap.class, Basic3DTest.class, TestMesh.class, TestMeshNoIndices.class,
                    TestMeshBuilder.class, TestTexture.class, SpriteBatchDoubleLoop.class, TransparencyTest.class,
                    TestCompute.class, ComputeMoldSlime.class, SpriteBatchBasic.class, SpriteBatchClear.class,
                    SpriteBatchDraw.class, SpriteBatchLimit.class, SpriteBatchTextures.class, SpriteBatchCount.class,
                    EnvironmentMapTest.class, Gamma3D.class, TextureArrayTest.class, SkyBoxTest.class, DuckField.class,
                    IBL_Sliders.class, IBL_Spheres.class, IBL_GenerateOutdoor.class, GLTFAnimation.class,
                    GLTFSkinning.class, Scene2dTestScrollPane.class, GLTFSkinningMultiple.class,
                    GLTFSkinningShadow.class, ParticleControllerTest.class, Particles3D.class, Particles3DSnow.class,
                    Particles3DmodelInstance.class
