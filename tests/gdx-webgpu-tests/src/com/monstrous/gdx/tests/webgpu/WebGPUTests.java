...
public class WebGPUTests {
    public static final List<Class<? extends GdxTest>> tests = new ArrayList<Class<? extends GdxTest>>(
            Arrays.<Class<? extends GdxTest>>asList(
                    ...
                    WrapAndFilterTest.class, LoadObjTest.class, LoadG3DJTest.class, LoadModelTest.class,
                    LoadGLTFTest.class, LightingTest.class, InstancingTest.class, ViewportTest.class, ScissorTest.class,
                    ASimpleGame.class, ParticleEmitterTest.class, ParticleEmittersTest.class, HeightMapTest.class,
                    FullScreenTest.class, GPUTimerTest.class, FrameBufferTest.class, PostProcessing.class,
                    SuperKoalio.class, DistanceFontTest.class, DepthClearTest.class, FogTest.class, ShadowTest.class,
