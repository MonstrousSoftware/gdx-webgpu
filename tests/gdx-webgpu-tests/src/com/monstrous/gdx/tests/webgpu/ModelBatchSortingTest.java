...
public class ModelBatchSortingTest extends GdxTest {
    ...
    public void create() {
        ...
        // model = modelBuilder.createXYZCoordinates(10, new Material(), VertexAttributes.Usage.Position |
        // VertexAttributes.Usage.ColorPacked);
        // model = modelBuilder.createLineGrid(1, 1, 10, 10, new Material(), VertexAttributes.Usage.Position |
        // VertexAttributes.Usage.ColorPacked);
