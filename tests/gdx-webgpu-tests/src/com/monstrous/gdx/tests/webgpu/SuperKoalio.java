...
import com.monstrous.gdx.webgpu.maps.tiled.WgTmxMapLoader;
import com.monstrous.gdx.webgpu.maps.tiled.renderers.WgOrthogonalTiledMapRenderer;

/**
 * Super Mario Brothers-like very basic platformer, using a tile map built using
 * <a href="http://www.mapeditor.org/">Tiled</a> and a tileset and sprites by
 * <a href="http://www.vickiwenderlich.com/">Vicky Wenderlich</a>
 * </p>
 *
...
public class SuperKoalio extends GdxTest {
    ...
    private WgOrthogonalTiledMapRenderer renderer;
    ...
    public void create() {
        ...
        koalaTexture = new WgTexture("data/maps/tiled/super-koalio/koalio.png");
        ...
        map = new WgTmxMapLoader().load("data/maps/tiled/super-koalio/level1.tmx");
        renderer = new WgOrthogonalTiledMapRenderer(map, 1 / 16f);
        ...
        debugRenderer = new WgShapeRenderer();
    }

    @Override
    public void render() {
        // clear the screen
        WgScreenUtils.clear(0.7f, 0.7f, 1.0f, 1);
    ...
    private void renderDebug() {
        ...
        debugRenderer.begin(WgShapeRenderer.ShapeType.Line);
