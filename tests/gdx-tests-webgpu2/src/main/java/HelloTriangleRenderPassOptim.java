...
public class HelloTriangleRenderPassOptim extends ApplicationAdapter {

    private WebGPUPipeline pipeline;
    private WebGPURenderPass renderPass;

    public static void main(String[] argv) {
        new WgDesktopApplication(new HelloTriangleRenderPassOptim());
    }
    ...
    public void create() {
        ...
        renderPass = RenderPassBuilder.create("my render pass", Color.YELLOW);
    }
