        ...
        if (asLDR) {
            ...
            for (int y = 0; y < imageHeight; y++) {
                for (int x = 0; x < imageWidth; x++) {
                    ...
                    RGBE.rgbe2float(pixel, hdrData, idx); // TODO exposure should be done in this call for best
                                                          // precision.
            ...
            // short[] pixels = new short[imageWidth * imageHeight * numComponents]; // 16 bit "short" to store 16-bit
            // floats
            // int index = 0;
            // for(int y=0 ; y<imageHeight ; y++){
            // for(int x=0 ; x<imageWidth ; x++){
