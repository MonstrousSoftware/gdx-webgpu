...
public class WgTmxMapLoader extends TmxMapLoader { //BaseTmxMapLoader<WgTmxMapLoader.Parameters> {

	public static class Parameters extends BaseTmxMapLoader.Parameters {

	}

	public WgTmxMapLoader() {
	 ...
	 *
	 * @param resolver */
	public WgTmxMapLoader(FileHandleResolver resolver) {
		super(resolver);
	}
