 ...
 * {@link Texture} containing the glyphs as a dependency. The {@link WgBitmapFontParameter} allows you to set things like texture
 * filters or whether to flip the glyphs vertically.
 * @author mzechner */
public class WgBitmapFontLoader extends AsynchronousAssetLoader<WgBitmapFont, WgBitmapFontLoader.WgBitmapFontParameter> {
	...
	@Override
	public WgBitmapFont loadSync (AssetManager manager, String fileName, FileHandle file, WgBitmapFontParameter parameter) {
		if (parameter != null && parameter.atlasName != null) {
	...
	static public class WgBitmapFontParameter extends AssetLoaderParameters<WgBitmapFont> {
		...
		/** The {@link TextureFilter} to use when scaling down the {@link WgBitmapFont}. Defaults to {@link TextureFilter#Nearest}. */
		public TextureFilter minFilter = TextureFilter.Nearest;

		/** The {@link TextureFilter} to use when scaling up the {@link WgBitmapFont}. Defaults to {@link TextureFilter#Nearest}. */
		...
		/** The name of the {@link TextureAtlas} to load the {@link WgBitmapFont} itself from. Optional; if {@code null}, will look
