 ...
 *
 * label: for debug/error messages, no functional value bufferSize: in bytes, to be aligned if necessary usage: one or
 * more flags in combination, e.g. WGPUBufferUsage.CopyDst | WGPUBufferUsage.Uniform
 */
