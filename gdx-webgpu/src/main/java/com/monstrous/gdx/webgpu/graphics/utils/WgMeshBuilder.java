...
public class WgMeshBuilder implements MeshPartBuilder {
	...
	private WgMeshPart part;
	/** The parts created between begin and end */
	private Array<WgMeshPart> parts = new Array<WgMeshPart>();
	...
	/** @param usage bitwise mask of the {@link Usage}, only Position, Color, Normal and
	 ...
	 * @param attributes bitwise mask of the {@link Usage}, only Position, Color, Normal
