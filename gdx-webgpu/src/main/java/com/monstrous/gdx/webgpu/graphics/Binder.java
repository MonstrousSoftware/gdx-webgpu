...
public class Binder implements Disposable {
    ...
    /**
     * Associates a name with a groupId + bindingId + offset. This is for a uniform in a uniform buffer.
     */
    ...
    public WebGPUBindGroup getBindGroup(int groupId) {
        ...
        if (bindGroup == null) {
            ...
            if (layout == null)
                throw new RuntimeException("Group " + groupId + " not defined. Use defineGroup()");
