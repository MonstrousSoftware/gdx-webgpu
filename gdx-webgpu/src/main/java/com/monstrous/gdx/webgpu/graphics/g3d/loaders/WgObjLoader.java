...
public class WgObjLoader extends WgModelLoader<WgObjLoader.ObjLoaderParameters> {
    /**
     * Set to false to prevent a warning from being logged when this class is used. Do not change this value, unless you
     * are absolutely sure what you are doing. Consult the documentation for more information.
     */
