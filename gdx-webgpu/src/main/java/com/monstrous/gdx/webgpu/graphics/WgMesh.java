...
public class WgMesh extends Mesh {
    ...
    public WgMesh(boolean isStatic, int maxVertices, int maxIndices, VertexAttribute... attributes) {
        this(new WgVertexBuffer(isStatic, maxVertices,new VertexAttributes(attributes)), new WgIndexBuffer(isStatic, maxIndices), false);
    }
    ...
    public WgMesh(boolean isStatic, int maxVertices, int maxIndices, boolean wideIndices, VertexAttributes attributes) {
        this(new WgVertexBuffer(isStatic, maxVertices, attributes), new WgIndexBuffer(isStatic, maxIndices, wideIndices), false);
    }
