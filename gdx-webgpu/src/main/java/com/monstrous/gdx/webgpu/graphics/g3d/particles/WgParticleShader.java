 ...
 * @author inferno */
public class WgParticleShader extends ParticleShader {
...
//	}
	...
	public WgParticleShader(final Renderable renderable, final Config config, final String prefix, final String vertexShader,
