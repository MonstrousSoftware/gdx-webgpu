...
public class MaterialsCache implements Disposable {
    ...
    public MaterialsCache(int maxMaterials) {
        ...
        materialBuffer = new WebGPUUniformBuffer(materialSize, WGPUBufferUsage.CopyDst.or(WGPUBufferUsage.Uniform),  maxMaterials);
        ...
        // define uniforms
        int offset = 0;
        binder.defineUniform("diffuseColor", group, 0, offset); offset += 4*4;
        binder.defineUniform("shininess", group, 0, offset); offset += 4;
        binder.defineUniform("roughnessFactor", group, 0, offset); offset += 4;
    ...
    public WebGPUBindGroupLayout createMaterialBindGroupLayout() {
        ...
        layout.begin();
            layout.addBuffer(0, WGPUShaderStage.Vertex.or(WGPUShaderStage.Fragment), WGPUBufferBindingType.Uniform, materialSize, true);
