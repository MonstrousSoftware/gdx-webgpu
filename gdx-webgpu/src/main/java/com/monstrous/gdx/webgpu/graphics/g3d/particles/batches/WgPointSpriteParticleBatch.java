...
public class WgPointSpriteParticleBatch extends BufferedParticleBatch<PointSpriteControllerRenderData> {
	...
	public WgPointSpriteParticleBatch(int capacity, ParticleShader.Config shaderConfig) {
		this(capacity, shaderConfig, null, null);
	}

	public WgPointSpriteParticleBatch(int capacity, ParticleShader.Config shaderConfig, BlendingAttribute blendingAttribute,
	...
	protected void allocParticlesData (int capacity) {
		...
		renderable.meshPart.mesh = new WgMesh(false, capacity, 0, CPU_ATTRIBUTES); // webgpu
	}
