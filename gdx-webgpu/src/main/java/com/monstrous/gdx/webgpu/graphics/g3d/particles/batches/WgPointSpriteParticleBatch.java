...
//	}
	...
	public WgPointSpriteParticleBatch() {
		this(1000);
	}

	public WgPointSpriteParticleBatch(int capacity) {
		this(capacity, new WgParticleShader.Config(WgParticleShader.ParticleType.Point));
	}
	...
	public WgPointSpriteParticleBatch(int capacity, WgParticleShader.Config shaderConfig, BlendingAttribute blendingAttribute,
		...
		renderable.shader = new WgParticleShader(renderable, shaderConfig);
	...
	protected void allocParticlesData (int capacity) {
		...
		renderable.meshPart.mesh = new WgMesh(false, capacity, 0, CPU_ATTRIBUTES);
	}
	...
	public void load (AssetManager manager, ResourceData resources) {
        ...
        //
        WgPointSpriteRenderer renderer = new WgPointSpriteRenderer();
