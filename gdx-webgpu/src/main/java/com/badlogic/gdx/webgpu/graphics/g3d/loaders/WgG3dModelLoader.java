...
package com.badlogic.gdx.webgpu.graphics.g3d.loaders;
...
public class WgG3dModelLoader extends WgModelLoader<WgModelLoader.ModelParameters> {
	public static final short VERSION_HI = 0;
	public static final short VERSION_LO = 1;
	protected final BaseJsonReader reader;

	public WgG3dModelLoader(final BaseJsonReader reader) {
		this(reader, null);
	}
