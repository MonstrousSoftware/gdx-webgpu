package com.monstrous.gdx.webgpu.teavm;
...
public class TeaVMBuilder {
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("com/monstrous/gdx/webgpu/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("com.monstrous.gdx.webgpu.reflect");
